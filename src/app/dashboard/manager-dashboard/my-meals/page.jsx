                  ...
                  <button
                    ...
                    className={`w-full h-10 rounded-lg font-bold text-xs flex items-center justify-center gap-1 transition-all ${
                      isPast
                        ...
                        : totalGuest > 0
                        ? "bg-amber-500 hover:bg-amber-600 text-white shadow-xs shadow-amber-500/20 active:scale-95 cursor-pointer"
                        : "border border-dashed border-gray-300 dark:border-slate-700 text-gray-500 dark:text-gray-400 hover:border-amber-500 hover:text-amber-600 dark:hover:text-amber-400 active:scale-95 cursor-pointer"
                    }`}
                  >
                    {totalGuest > 0 ? (
                      <>
          ...
          <div className="bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 rounded-2xl max-w-md w-full p-5 sm:p-6 shadow-2xl space-y-4">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <button
                        ...
                        className="w-8 h-8 rounded-lg bg-gray-100 dark:bg-slate-700 hover:bg-gray-200 dark:hover:bg-slate-600 disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center text-gray-700 dark:text-gray-200 font-bold transition active:scale-95 cursor-pointer"
                      >
                      ...
                      <button
                        ...
                        className="w-8 h-8 rounded-lg bg-amber-500 hover:bg-amber-600 disabled:opacity-40 disabled:cursor-not-allowed flex items-center justify-center text-white font-bold transition active:scale-95 shadow-xs cursor-pointer"
                      >
            ...
            <div className="flex gap-2 pt-2">
              <button
                type="button"
                onClick={() => setSelectedGuestDay(null)}
                className="flex-1 py-2.5 px-4 bg-gray-100 dark:bg-slate-800 hover:bg-gray-200 dark:hover:bg-slate-700 rounded-xl text-xs sm:text-sm font-semibold transition cursor-pointer"
              >
                {isBn ? "বাতিল" : "Cancel"}
              </button>
              <button
                ...
                className="flex-1 py-2.5 px-4 bg-amber-500 hover:bg-amber-600 text-white rounded-xl text-xs sm:text-sm font-bold shadow-md shadow-amber-500/20 disabled:opacity-50 transition flex items-center justify-center gap-1.5 cursor-pointer"
              >
                {isSavingGuest ? (
